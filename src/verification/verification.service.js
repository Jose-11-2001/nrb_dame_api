...
var VerificationService = function () {
    ...
    var VerificationService = _classThis = /** @class */ (function () {
        function VerificationService_1(nationalIdRepository, deathRepository) {
            this.nationalIdRepository = nationalIdRepository;
            this.deathRepository = deathRepository;
        }
        VerificationService_1.prototype.verifyNationalId = function (nationalIdNumber, surname) {
            return __awaiter(this, void 0, void 0, function () {
                var record;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.nationalIdRepository.findOne({
                                where: {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, {
                                    verified: true,
                                    data: {
                                        fullName: "".concat(record.firstName, " ").concat(record.surname),
        ...
        VerificationService_1.prototype.verifyDeathCertificate = function (certificateNumber, deceasedNationalId) {
            return __awaiter(this, void 0, void 0, function () {
                var record;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.deathRepository.findOne({
                                where: {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, {
                                    verified: true,
                                    data: {
                                        deceasedName: "".concat(record.firstName, " ").concat(record.surname),
