...
var VerificationController = function () {
    var _classDecorators = [(0, common_1.Controller)('api/v1/verify')];
    ...
    var VerificationController = _classThis = /** @class */ (function () {
        ...
        // @Public()
        VerificationController_1.prototype.verifyNationalId = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.verificationService.verifyNationalId(body.nationalIdNumber, body.lastName)];
                });
            });
        };
        // @Public()
        VerificationController_1.prototype.verifyDeathCertificate = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.verificationService.verifyDeathCertificate(body.certificateNumber, body.deceasedNationalId)];
                });
            });
        };
    ...
    (function () {
        ...
        _verifyNationalId_decorators = [(0, common_1.Post)('national-id'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _verifyDeathCertificate_decorators = [(0, common_1.Post)('death-certificate'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
